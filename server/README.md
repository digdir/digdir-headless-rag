...
If using [Mise](https://mise.jdx.dev/) to manage tool versions, you'll need to install libyaml first:
...
* Electric root function: [src/admin_app/main.cljc](src/admin_app/main.cljc)
